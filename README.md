...
![가맹점 등록 페이지(직접 구현)](./src/app/public/9.png)

- 목업 페이지로만 구성하였습니다.
- 상세조회와 동일하게 기존 페이지 이동이 아닌 별도의 창을 띄워 업무 중 효율성이 높게 설계하였습니다.

### 가맹점 등록 페이지 폼 제출 후 데이터 조회(직접 구현)

![가맹점 등록 페이지(직접 구현)](./src/app/public/10.png)

- 데이터가 올바르게 할당되어 조회 여부를 위해 모달로 임시 구성하였습니다.
